...
mlflow.set_tracking_uri("https://mlflow.YOURSITE.co/")
...
Let's have a look at the results: https://mlflow.YOURSITE.co/
...
... And verify that it logged correctly on https://mlflow.YOURSITE.co/
...
print(f"experiment URL: https://mlflow.YOURSITE.co/#/experiments/{experiment_id}")
```
